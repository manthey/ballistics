...
Copyright 2013-2016 by David Manthey
...
PROGRAM_SIGNATURE = '81dd50788f9cd9c9f8e78d7889be493f'
...
def trajectory(state):  # noqa - mccabe
    ...
    state = determine_material(state)
...
power factor, and change should be specified.  If only initial velocity is
